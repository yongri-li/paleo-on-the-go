  ...
  <div class="subtotal">
    <div class="subtotal__content">
      ...
      <div class="subtotal__agree">
        ...
        <a href="#" target="_blank" class="subtotal__agree--redirect">
  ...
  computed: {
    ...
    finalSubtotal() {
      return formatPriceDollars(
        this.getBoxPrices.final +
          this.getAddonPrices / 100 +
          this.getGeneralPrices / 100
      );
    },
    items() {
    ...
    async checkout() {
      ...
      if (this.sizeSelected.order_type === "subscription") {
        const appRequest = await fetch(
          "https://paleo-custom-app.herokuapp.com/plan/checkout",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",

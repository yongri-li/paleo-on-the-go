    ...
    <div class="c-shipmentsBox__flex">
      <div class="c-shipmentsBox__flexSmall">
        <div class="c-shipmentsBox__shipping">
          <span
            class="c-shipmentsBox__shippingCharges u-block"
            v-html="'this box charges'"
          />
          <c-h
            class="c-shipmentsBox__shippingDate"
            tag="time"
            level="1"
            :text="'Mar 22'"
          />
          ...
          />
          <span
            class="c-shipmentsBox__shippingTo u-block"
            v-html="'Ships To'"
          />
          <c-button
            class="c-shipmentsBox__shippingAddress u-block"
            :text="'17 Princess Street'"
          />
        </div>
      </div>

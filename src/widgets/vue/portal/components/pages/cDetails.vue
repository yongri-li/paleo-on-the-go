<template>
  <div :class="_buildModifiers('c-details', modifiers)">
    ...
    <div class="c-details__content" v-if="ready">
      <c-h
        class="c-details__heading u-hideMobileDown"
      ...
      <div class="c-details__box">
        <div class="c-details__boxSingle" v-if="customerRecharge">
          <c-detailsBlock class="c-details__boxItem" :heading="content.billing_label">
            <c-p
              class="c-details__boxText"
              tag="address"
              level="2"
              v-html="
                _buildAddress({
        ...
        <div class="c-details__boxGroup">
          ...
          <c-detailsBlock class="c-details__boxItem" :heading="content.password_label">
            <c-p
              class="c-details__boxText"
              tag="p"
              level="2"

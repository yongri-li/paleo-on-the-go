<template>
  <div :class="_buildModifiers('c-sidebarRetention', modifiers)" v-if="content && address">
    <c-p
      class="c-sidebarRetention__address"
      tag="address"
      level="1"
      :modifiers="['isBolder']"
      :text="
    ...
    <div class="c-sidebarRetention__box">
      <c-img class="c-sidebarRetetion__image" v-if="content.retention_image" :src="content.retention_image" />
      <c-h
        class="c-sidebarRetention__pretext"
        tag="h6"
        level="6"
        :modifiers="['isEyebrow']"
      ...
      />
      <c-h
        class="c-sidebarRetention__text"
        tag="h4"
        level="4"
        :modifiers="['isBolder']"
      ...
      <div class="c-sidebarRetention__actions">
        <button class="c-sidebarRetention__action" onclick="Smooch.open();">
          <div class="c-sidebarRetention__actionIcon">
            <c-img
              class="c-sidebarRetention__actionImage"
              v-if="content.retention_chat_icon"
              :src="content.retention_chat_icon"
            />
          </div>
          <c-h
            class="c-sidebarRetention__actionHeading"
            tag="h6"
            level="6"
            :modifiers="['isEyebrow']"
          ...
          />
          <c-p
            class="c-sidebarRetention__actionText"
            tag="p"
            level="4"
            :modifiers="['isBolder']"
        ...
        <button
          class="c-sidebarRetention__action"
          @click="
            UI_SET_MODAL({
      ...
      <c-button
        class="c-sidebarRetention__cancelButton"

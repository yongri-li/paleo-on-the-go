...
const apiKey = allCookies.split('; ').find(row => row.includes('ss_api_key'))
const apiCustomerToken = allCookies.split('; ').find(row => row.includes('ss_customer_token'))
const apiAccessToken = allCookies.split('; ').find(row => row.includes('ss_access_token'))
